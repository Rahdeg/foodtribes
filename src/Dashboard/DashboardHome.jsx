...
import { getAllBike, getAllItems, getAllPayments, getAllUser } from '../utils.js/firebasefunctions';
import { DashboardCard } from './Cards';


const DashboardHome = () => {
  const [{allUsers,bikedetails,allItems,paymentdetails},dispatch]=useStateValue();
